...
/*
 * Okta Applications Endpoint
 * https://github.com/okta/api/blob/master/docs/endpoints/apps.md @ 62cd5a49ec
 */
 /**
 ...
 */
 OktaAPI.prototype.getApplications = function(filter, callback) {
    var queryObj;
    if(filter != undefined) queryObj.filter = filter;
    this.request.get("apps", null, queryObj, callback);
 }
...
OktaAPI.prototype.deleteApplication = function(id, callback) {
    ...
    this.request.delete("apps/" + id, null, null, callback);
}
...
OktaAPI.prototype.getAssignedUserForApplication = function(appId, uid, callback) {
    ...
    this.request.get("apps/" + appId + "/users/" + uid, null, null, callback);
}
...
OktaAPI.prototype.getUsersAssignedToApplication = function(id, callback) {
    ...
    this.request.get("apps/" + id + "/users", null, null, callback);
}
...
OktaAPI.prototype.updateCredsForApplication = function(aid, uid, appUserModel, callback) {
    ...
    this.request.put("apps/" + aid + "/users/" + uid, appUserModel, null, callback);
}
...
OktaAPI.prototype.removeUserFromApplication = function(aid, uid, callback) {
    ...
    this.request.delete("apps/ " + aid + "/users/" + uid, null, null, callback);
}
...
OktaAPI.prototype.assignApplicationToGroup = function(aid, gid, callback) {
    ...
    this.request.put("apps/" + aid + "/groups/" + gid, null, null, callback);
}
...
OktaAPI.prototype.getGroupAssignedToApplication = function(aid, gid, callback) {
    ...
    this.request.get("apps/" + aid + "/groups/" + gid, null, null, callback);
}

OktaAPI.prototype.getGroupsAssignedToApplication = function(aid, callback) {
    if(aid == undefined) throw new Error("An application ID is required when getting the groups assigned to an application");
    this.request.get("apps/" + aid + "/groups", null, null, callback);
}
